#!/usr/bin/env bash
# Sleep Deprivation FM experiments: 3 models × 3 seeds × 2 modes (LP, FT)
# Usage: bash scripts/_run_exp_sleepdep.sh cuda:7
set -o pipefail
...
echo "=== SleepDep experiments on ${GPU} ==="
