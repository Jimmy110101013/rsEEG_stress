#!/usr/bin/env bash
# Non-FM architecture ceiling on EEGMAT (Fig 6 expansion)
# 2 models × 3 seeds = 6 runs, sequential on one GPU.
# Usage: bash scripts/experiments/_run_nonfm_eegmat.sh cuda:5
set -o pipefail
...
echo "=========================================="
echo "NON-FM × EEGMAT on ${GPU} — $(date)"
echo "=========================================="
