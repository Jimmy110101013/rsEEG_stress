#!/usr/bin/env bash
# Window-level FT feature extraction — REVE (single seed, 4 datasets)
# Canonical HP (G-F09) matching results/final/*/ft/reve/seed42/config.json.
...
echo "[$(date +%H:%M:%S)] REVE winfeat chain DONE"
