...
>
> Full evidence: `results/studies/exp03_stress_erosion/analysis.json`.
...
`results/studies/exp03_stress_erosion/analysis.json`.
...
`results/studies/exp04_eegmat_feat_multiseed/`.
