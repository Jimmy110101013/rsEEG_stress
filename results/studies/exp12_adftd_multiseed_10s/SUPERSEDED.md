...
**Date**: 2026-04-23
**Superseded by**: `results/final/adftd/ft/reve/seed{42,123,2024}/`
...
- `results/final/adftd/ft/reve/` FT runs consume the split1 / per-FM HP pipeline directly; the separate exp12 split (window-size-only variant for REVE) is no longer needed.

## Canonical location now

`results/final/adftd/ft/reve/seed{42,123,2024}/summary.json`
