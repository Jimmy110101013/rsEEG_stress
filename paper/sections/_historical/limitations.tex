...
Sec.~\ref{sec:results_paired} consists of 70
...
The architecture panel in Sec.~\ref{sec:results_paired} includes
...
Sec.~\ref{sec:results_paired} does not rely on cross-FM ranking; it
